...
package cn.laclab.client.finaldownload.core.util;
...
public class OtherUtils {
    ...
    public static boolean isSupportRange(final HttpURLConnection conn) {
    ...
    public static String getFileNameFromHttpResponse(final HttpURLConnection conn) {
